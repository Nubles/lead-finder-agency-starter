...
| :----------------------------------------- | :------ | :---------------------------------------------------------------------------- | :-------------------------- |
| **Search or Directory URLs** (`startUrls`) | Array   | List of target directories or search result URLs to scan.                     | _(Prefilled with Yell.com)_ |
...
```json
{
    ...
    "emails": ["info@exampledental.co.uk"],
    "phones": ["0161 496 0123"],
    "contactUrls": ["https://www.exampledental.co.uk/book-online"],
    "socialUrls": ["https://instagram.com/exampledental"],
    "websiteCandidates": [],
    "leadStatus": "hot",
